...
time cd /home/caffe/caffe/py-faster-rcnn/tools/
python train_faster_rcnn_alt_opt.py --net_name ${NET} \
  --weights /home/caffe/caffe/py-faster-rcnn/data/imagenet_models/${NET}.v2.caffemodel \
  --imdb ${TRAIN_IMDB} \
  --cfg /home/caffe/caffe/py-faster-rcnn/experiments/cfgs/faster_rcnn_alt_opt.yml \
  ${EXTRA_ARGS}
